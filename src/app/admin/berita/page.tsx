    ...
    <>
      <section className="bg-blue-900 py-16 text-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6">
          <div>
            <h1 className="text-5xl font-bold">Kelola Berita</h1>
          ...
          <Link
            ...
            className="rounded-lg bg-yellow-400 px-5 py-3 font-semibold text-blue-900 hover:bg-yellow-300 transition"
          >
            + Tambah Berita
          </Link>
        </div>
                  ...
                  <tr key={item.id}>
                    ...
                    <td className="border p-3 text-center">
                      {item.image && item.image.trim() !== "" ? (
                        /* Menggunakan HTML img biasa agar aman membaca Base64 & URL eksternal */
                        <img
                          src={item.image}
                          alt={item.title}
                          className="mx-auto h-16 w-24 rounded object-cover border"
                        />
                      ) : (
                    ...
                    <td className="border p-3 text-sm">{item.date}</td>
                    ...
                    <td className="border p-3">
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Link
                          ...
                          className="rounded bg-blue-600 px-3 py-2 text-sm text-white hover:bg-blue-700 transition"
                        >
                          Edit
                        </Link>
